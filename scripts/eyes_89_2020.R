...
eyes_89_2020<-read.delim(file= "C1254RT.TXT", sep="\t", header=TRUE)#loading in data
names(eyes_89_2020)
...
eyes_89_2020_t<-subset(eyes_89_2020_f,Date >= as.POSIXct('2020-05-20 08:53:14', tz="UTC")) # do from last indicator

#this time is 45 minutes from the above time manually write this
eyes_89_2020_t2<-subset(eyes_89_2020_t,Date <= as.POSIXct('2020-05-20 09:37:02', tz="UTC")) # make sure 45 mins
#not exactly 45mins 
...
eyes_89_2020_b.3<-cbind(eyes_89_2020_b.3, nestbox='mw89') 
...
write.csv(latency_final_eyes_89_2020,file="totalVisits45m_mw89_2020.csv")
