...
eyes_9_2019<-read.delim(file= ".TXT", sep="\t", header=TRUE)#loading in data
names(eyes_9_2019)
...
eyes_9_2019_t<-subset(eyes_9_2019_f,Date >= as.POSIXct('', tz="UTC")) # do from last indicator

#this time is 45 minutes from the above time manually write this
eyes_9_2019_t2<-subset(eyes_9_2019_t,Date <= as.POSIXct('', tz="UTC")) # make sure 45 mins
#not exactly 45mins 
...
eyes_9_2019_b.3<-cbind(eyes_9_2019_b.3, nestbox='mw') 
...
write.csv(latency_final_eyes_9_2019,file="totalVisits45m_mw_2019.csv")
